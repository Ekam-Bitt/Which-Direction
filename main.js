...
`),
  ...
  xn({ font: "sans", background: [255, 153, 153] });
  ...
  const introText = `
		Welcome to[wavy] "Which Direction?"[/wavy] Game 
		Made by Ekam B 
	  
		Use the arrow keys to move Harry 
		Eat Harry's favorite Watermelons while escaping from Ringo :P 
	  
		[wavy] Press Sp[/wavy]ace Bar to Start the Game
	  `;
